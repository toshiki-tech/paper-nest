          ...
          <Card className="border-warm-200 hover:shadow-xl transition-all duration-500 bg-white/80 backdrop-blur-sm">
            <CardHeader className="pb-6">
              <CardTitle className="flex items-center text-2xl">
                <div className="w-12 h-12 bg-gradient-to-br from-secondary-500 to-primary-600 rounded-xl flex items-center justify-center mr-4">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="border-warm-200">
              <CardHeader>
                <CardTitle className="flex items-center">
                  <div className="w-10 h-10 bg-gradient-to-br from-warm-100 to-secondary-100 rounded-lg flex items-center justify-center mr-3">
            ...
            <Card className="border-accent-200">
              <CardHeader>
                <CardTitle className="flex items-center">
                  <div className="w-10 h-10 bg-gradient-to-br from-accent-100 to-cool-100 rounded-lg flex items-center justify-center mr-3">
            ...
            <Card className="border-cool-200">
              <CardHeader>
                <CardTitle className="flex items-center">
                  <div className="w-10 h-10 bg-gradient-to-br from-cool-100 to-warm-100 rounded-lg flex items-center justify-center mr-3">
                    <span className="text-cool-600">🔬</span>
                  </div>
                  实践应用
                </CardTitle>
              </CardHeader>
